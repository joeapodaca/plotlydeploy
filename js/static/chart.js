...
function buildCharts(sample) {
  ...
  d3.json("samples.json").then((data) => {
    ...
    var otuIds = id.otu_ids;
    var otuLabels  = id.otu_labels;
    var sampleValues = id.sample_values;
    ...
    var gaugeLayout = { 
      title: "<b>Belly Button Washing Frequency<br>Scrubs per Week",
      xaxis: {title: "OTU ID"},
      };
